(function() {
    if (! ("SVGPathSeg" in window)) {
        ...
        window.SVGPathSegLinetoAbs = function(a, o, e) {
        ...
        SVGPathElement.prototype.createSVGPathSegLinetoRel = function(a, o) {
        ...
        SVGPathElement.prototype.createSVGPathSegCurvetoQuadraticRel = function(a, o, e, b) {
        ...
        SVGPathElement.prototype.createSVGPathSegCurvetoCubicSmoothRel = function(a, o, e, b) {
    ...
    if (! ("SVGPathSegList" in window)) {
        ...
        SVGPathSegList.prototype._parsePath = function(a) {
            ...
            b.prototype._pathSegTypeFromChar = function(l) {
                switch (l) {
                case "Z":
                case "z":
            ...
            b.prototype.initialCommandIsMoveTo = function() {
                ...
                return l == SVGPathSeg.PATHSEG_MOVETO_ABS || l == SVGPathSeg.PATHSEG_MOVETO_REL
            };
            b.prototype._parseNumber = function() {
                ...
                if (! (this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || this._string.charAt(this._currentIndex) > "9") && this._string.charAt(this._currentIndex) != ".")) {
                    ...
                    if (this._currentIndex != C) for (var v = this._currentIndex - 1,
                    L = 1; v >= C;) {
            ...
            b.prototype.parseSegment = function() {
                ...
                case SVGPathSeg.PATHSEG_LINETO_ABS:
                    return new SVGPathSegLinetoAbs(o, this._parseNumber(), this._parseNumber());
                ...
                case SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS:
                    ...
                    return new SVGPathSegCurvetoCubicAbs(o, l.x, l.y, l.x1, l.y1, l.x2, l.y2);
                ...
                case SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_SMOOTH_ABS:
                    return new SVGPathSegCurvetoQuadraticSmoothAbs(o, this._parseNumber(), this._parseNumber());
...
function touchHandler(a) {
    ...
    a.svgIcons = function(b, l) {
        ...
        function c(ka, Z) {
            if (!H) {
                ...
                l.placement && a.each(l.placement,
                function(Ia, Ka) {
        ...
        var ta = function(ka, Z, da, pa) {
            ...
            if (l.replace) {
                pa && Z.attr("id", da); (da = ka.attr("class")) && Z.attr("class", "svg_icon " + da);
                ka.replaceWith(Z)
            } else ka.append(Z);
    ...
    function a(b, l, s) {
        ...
        if (e) for (var c in l) b.setAttribute(c, l[c]);
        else for (c in l) {
            var g = l[c],
            d = b[c];
    ...
    if (!window.console) window.console = new
    function() {
        this.log = function() {};
        this.dir = function() {}
    };
        ...
        return this.each(function() {
            function s(ha, Y, ja, M, P) {
                ...
                $(Ca).mousedown(function(Ma) {
                    ...
                    for (var Ma = this,
                    Wa = +ba.getAttribute("stop-opacity") || 1, Za = ba.getAttribute("stop-color") || 1, nb = (parseFloat(Wa) * 255).toString(16); nb.length < 2;) nb = "0" + nb;
                    Y = Za.substr(1) + nb;
            ...
            function d() {
                ...
                $a === 1 && Ga === 1 ? fa.removeAttribute("gradientTransform") : fa.setAttribute("gradientTransform", ha + "translate(" + -Ea * ($a - 1) + "," + -db * (Ga - 1) + ") scale(" + $a + "," + Ga + ")")
            }
            function p(ha) {
            ...
            if (L) {
                ...
                $(L + " .grad_coord");
                $.each(["x1", "y1", "x2", "y2", "cx", "cy", "fx", "fy"],
                function(ha, Y) {
                    var ja = fa.getAttribute(Y),
                    M = isNaN(Y[1]);
                    ja || (ja = M ? "0.5": Y === "x2" ? "1.0": "0.0");
                    ia[Y] = $("#" + v + "_jGraduate_" + Y).val(ja).change(function() {
                ...
                if (sa < 2) {
                    for (; sa < 2;) {
                        fa.appendChild(document.createElementNS(o.svg, "stop")); ++sa
                    }
                    wa = fa.getElementsByTagNameNS(o.svg, "stop")
                }
                var sa = wa.length;
                ...
                $("#" + v + "_jGraduate_Ok").bind("click touchstart",
                function() {
                    w.paint.type = W;
                ...
                $("#" + v + "_jGraduate_Cancel").bind("click touchstart",
                function() {
                    J()
                });
                if (W === "radialGradient") if (eb) ra.show();
                else {
                    ra.hide();
                    ia.fx.val("");
                    ia.fy.val("")
                ...
                if (W === "radialGradient") {
                    ...
                    if (Z.numberOfItems === 2) {
                        ...
                        sa = Z.getItem(1);
                        Z = Z.getItem(2);
                        if (ka.type === 4 && sa.type === 2 && Z.type === 3) {
                ...
                N = N.split(".")[0];
                H = w.paint.solidColor == "none" ? "": w.paint.solidColor + N;
            ...
            $(this).each(function() {
                ...
                function(d) {
                    ...
                    function(p) {
                        ...
                        w.unbind("mouseup");
                        $(".contextMenu").hide();
                        if (d.button === 2 || e.allowLeft || d.ctrlKey && svgedit.browser.isMac()) svgedit.browser.isTouch() || g(p, d, w)
                    })
                });
                svgedit.browser.isTouch() && $(this).bind("taphold",
                function(d) {
                    var p = $(this);
                    p.unbind("mouseup");
                    g(d, d, p)
                ...
                $(l).add($("UL.contextMenu")).bind("contextmenu",
                function() {
                    return false
                })
            });
...
var svgedit = svgedit || {}; (function() {
    ...
    if (svgedit.browser.supportsSvg()) {
        ...
        H = function() {
            ...
            ca.setAttribute("x", 0.1); (ca = ca.cloneNode(false).getAttribute("x").indexOf(",") == -1) || $.alert("NOTE: This version of Opera is known to contain bugs in SVG-edit.\n    Please upgrade to the <a href='http://opera.com'>latest version</a> in which the problems have been fixed.");
            return ca
        } (),
        U = function() {
            var ca = document.createElementNS("http://www.w3.org/2000/svg", "rect");
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.transformlist.SVGTransformList = function(e) {
        ...
        this._update = function() {
            ...
            for (var l = 0; l < this.numberOfItems; ++l) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    g = c.a == c.d ? "scale(" + c.a + ")": "scale(" + c.a + "," + c.d + ")";
                    break;
                case 4:
                    var d = 0;
                    g = 0;
        ...
        this._init = function() {
            ...
            if (b) for (var l = /\s*((scale|matrix|rotate|translate)\s*\(.*?\))\s*,?\s*/,
            s = true; s;) {
                s = b.match(l);
                b = b.replace(l, "");
                if (s && s[1]) {
        ...
        this.removeItem = function(b) {
            if (b < this.numberOfItems && b >= 0) {
                for (var l = this._xforms[b], s = Array(this.numberOfItems - 1), c = 0; c < b; ++c) s[c] = this._xforms[c];
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.units.setUnitAttr = function(c, g, d) {
    ...
    svgedit.units.convertToNum = function(c, g) {
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.utilities.text2xml = function(c) {
        ...
        var g;
        try {
            var d = window.DOMParser ? new DOMParser: new ActiveXObject("Microsoft.XMLDOM");
            d.async = false
        } catch(p) {
    ...
    svgedit.utilities.getUrlFromAttr = function(c) {
        if (c) if (c.indexOf('url("') === 0) return c.substring(5, c.indexOf('"', 6));
    ...
    svgedit.utilities.getHref = function(c) {
        if (c) return c.getAttributeNS("http://www.w3.org/1999/xlink", "href")
    };
    ...
    function(c) {
        return b.evaluate('svg:svg[@id="svgroot"]//svg:*[@id="' + c + '"]', l,
        function() {
    ...
    svgedit.utilities.assignAttributes = function(c, g, d, p) {
        for (var w in g) if (d = w.substr(0, 4) === "xml:" ? "http://www.w3.org/XML/1998/namespace": w.substr(0, 6) === "xlink:" ? "http://www.w3.org/1999/xlink": null) c.setAttributeNS(d, w, g[w]);
            ...
            if (l.ownerDocument && s) {
                ...
                if (c != undefined) {
                    ...
                    if (l.nodeName == "use" && !svgedit.utilities.getHref(l)) s.removeChild(l);
                        ...
                        $.each(["clip-path", "fill", "filter", "marker-end", "marker-mid", "marker-start", "mask", "stroke"],
                        function(Q, J) {
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.history.ChangeElementCommand.prototype.apply = function(a) {
        ...
        for (e in this.newValues) {
            if (this.newValues[e]) if (e == "#text") this.elem.textContent = this.newValues[e];
    ...
    svgedit.history.ChangeElementCommand.prototype.unapply = function(a) {
        ...
        for (e in this.oldValues) {
            if (this.oldValues[e]) if (e == "#text") this.elem.textContent = this.oldValues[e];
    ...
    svgedit.history.BatchCommand.prototype.apply = function(a) {
        a && a.handleHistoryEvent(svgedit.history.HistoryEventTypes.BEFORE_APPLY, this);
        for (var o = this.stack.length,
        e = 0; e < o; ++e) this.stack[e].apply(a);
        a && a.handleHistoryEvent(svgedit.history.HistoryEventTypes.AFTER_APPLY, this)
    };
    ...
    svgedit.history.UndoManager.prototype.beginUndoableChange = function(a, o) {
        for (var e = ++this.undoChangeStackPointer,
        b = o.length,
        l = Array(b), s = Array(b); b--;) {
            var c = o[b];
            if (c != null) {
                s[b] = c;
    ...
    svgedit.history.UndoManager.prototype.finishUndoableChange = function() {
        for (var a = this.undoChangeStackPointer--,
        o = this.undoableChangeStack[a], e = o.elements.length, b = o.attrName, l = new svgedit.history.BatchCommand("Change " + b); e--;) {
            var s = o.elements[e];
            if (s != null) {
                var c = {};
                c[b] = o.oldValues[e];
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.select.Selector = function(b, l) {
        ...
        svgedit.browser.isTouch() && this.selectorRect.setAttribute("stroke-opacity", 0.3);
        this.gripCoords = {
            nw: null,
            n: null,
            ne: null,
    ...
    svgedit.select.Selector.prototype.updateGripCursors = function(b) {
        ...
        for (s in e.selectorGrips) {
            e.selectorGrips[s].setAttribute("style", "cursor:" + l[b] + "-resize");
            b++
        }
    };
    ...
    svgedit.select.Selector.prototype.resize = function() {
        ...
        d = a.currentZoom(),
        p = 1 / d;
        if (c.getAttribute("stroke") !== "none" && !isNaN(g)) p += g / 2;
        var w = c.tagName;
        if (w === "text") p += 2 / d;
        ...
        b.setAttribute("d", "M" + w + "," + v + " L" + (w + Q) + "," + v + " " + (w + Q) + "," + (v + L) + " " + w + "," + (v + L) + "z");
    ...
    svgedit.select.SelectorManager.prototype.releaseSelector = function(b) {
        if (b != null) for (var l = this.selectors.length,
        s = this.selectorMap[b.id], c = 0; c < l; ++c) if (this.selectors[c] && this.selectors[c] == s) {
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.draw.randomizeIds = function(b, l) {
        e = b == false ? o.NEVER_RANDOMIZE: o.ALWAYS_RANDOMIZE;
    ...
    svgedit.draw.Drawing.prototype.identifyLayers = function() {
        this.all_layers = [];
        for (var b = this.svgElem_.childNodes.length,
        l = [], s = [], c = null, g = false, d = 0; d < b; ++d) {
    ...
    svgedit.draw.Drawing.prototype.createLayer = function(b) {
        ...
        s = l.createElementNS("http://www.w3.org/2000/svg", "g");
    ...
    svgedit.draw.Drawing.prototype.getLayerVisibility = function(b) {
        for (var l = null,
        s = 0; s < this.getNumLayers(); ++s) if (this.getLayerName(s) == b) {
    ...
    svgedit.draw.Drawing.prototype.setLayerVisibility = function(b, l) {
        ...
        for (var s = null,
        c = 0; c < this.getNumLayers(); ++c) if (this.getLayerName(c) == b) {
    ...
    svgedit.draw.Drawing.prototype.getLayerOpacity = function(b) {
        for (var l = 0; l < this.getNumLayers(); ++l) if (this.getLayerName(l) == b) { (b = this.all_layers[l][1].getAttribute("opacity")) || (b = "1.0");
            return parseFloat(b)
        }
        return null
    };
    svgedit.draw.Drawing.prototype.setLayerOpacity = function(b, l) {
        if (! (typeof l != "number" || l < 0 || l > 1)) for (var s = 0; s < this.getNumLayers(); ++s) if (this.getLayerName(s) == b) {
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.path.Segment = function(g, d) {
        this.selected = false;
        this.index = g;
        this.item = d;
    ...
    svgedit.path.Segment.prototype.show = function(g) {
        if (this.ptgrip) {
            this.ptgrip.setAttribute("display", g ? "inline": "none");
    ...
    svgedit.path.Path.prototype.eachSeg = function(g) {
        for (var d = this.segs.length,
        p = 0; p < d; p++) if (g.call(this.segs[p], p) === false) break
    };
    svgedit.path.Path.prototype.addSeg = function(g) {
        ...
        if (d.prev) {
            ...
            case 6:
                ...
                svgedit.path.replacePathSeg(d.type, g, [d.item.x, d.item.y, L, U, Q, p])
            }
    ...
    svgedit.path.Path.prototype.show = function(g) {
        this.eachSeg(function() {
            this.show(g)
        });
    ...
    svgedit.path.Path.prototype.setSegType = function(g) {
        this.storeD();
        for (var d = this.selected_pts.length,
        p; d--;) {
...
if (window.opera) {
    ...
    jQuery.fn.attr = function(o, e) {
        ...
        for (var l = 0; l < b; l++) {
            var s = this[l];
            if (s.namespaceURI === "http://www.w3.org/2000/svg") if (e !== undefined) s.setAttribute(o, e);
            else if ($.isArray(o)) {
                b = o.length;
                for (l = {}; b--;) {
                    var c = o[b],
                ...
                return l
            } else if (typeof o === "object") for (c in o) s.setAttribute(c, o[c]);
            else {
...
$.SvgCanvas = function(a, o) {
    ...
    a.appendChild(d);
    var p = g.createElementNS(b, "svg"); (c.clearSvgContentElement = function() {
            ...
            try {
                ...
                if (q && q % 90 || svgedit.math.hasMatrixTransform(svgedit.transformlist.getTransformList(k))) {
                    ...
                    if (!q) {
                        ...
                        K = document.createElementNS(b, "g"),
                        O = k.parentNode;
                        O.appendChild(K);
                        K.appendChild(I);
    ...
    Za = this.remapElement = function(f, h, m) {
        ...
        case "circle":
            ...
            h.r = Math.min((G.tr.x - G.tl.x) / 2, (G.bl.y - G.tl.y) / 2);
    ...
    Qa = this.recalculateDimensions = function(f) {
        ...
        if (h) {
            ...
            if (A.length === 2) {
                m = d.createSVGTransformFromMatrix(ca(A[1][0], A[0][0]));
                h.removeItem(A[0][1]);
                h.removeItem(A[1][1]);
        ...
        case "path":
            break;
        default:
            if (h.numberOfItems === 1 && h.getItem(0).type === 1 || h.numberOfItems === 2 && h.getItem(0).type === 1 && h.getItem(0).type === 4) return null
        }
        var G = $(f).data("gsvg");
        m = new Ba("Transform");
        var D = {},
    ...
    mb = null,
    ya = this.clearSelection = function(f) {
        if (H[0] != null) for (var h = H.length,
        m = 0; m < h; ++m) {
            var B = H[m];
            if (B == null) break;
    ...
    qb = this.addToSelection = function(f, h) {
        if (f.length != 0) {
            ...
            M("selected", H);
            h || H.length == 1 ? ra.requestSelector(H[0]).showGrips(true) : ra.requestSelector(H[0]).showGrips(false);
    ...
    var Bb = this.getMouseTarget = function(f) {
        ...
        $(a).mousedown(function(z) {
            ...
            if (! (z.originalEvent.touches && z.originalEvent.touches.length > 1)) if (Ga) if (! (z.button === 1 || c.spaceKey)) {
                var F = H[0],
                    ...
                    if (H[0] !== null) {
                        ...
                        if (u != 0 || I != 0) {
                            ...
                            if (z.altKey) if (!c.addClones) {
                                c.addClones = c.cloneSelectedElements(0, 0, V);
                ...
                if (Ga) {
                    ...
                    case "select":
                        if (H[0] != null) {
                            ...
                            if (svgedit.browser.supportsNonScalingStroke()) if (z = H[0]) {
                                z.removeAttribute("style");
                                svgedit.utilities.walkTree(z,
                                function(V) {
                    ...
                    if (!I && E != null) {
                        ...
                        z = 0.2;
                        var K;
                        if (false.beginElement && E.getAttribute("opacity") != J.opacity) {
                            K = $(false).clone().attr({
                                to: J.opacity,
                                dur: z
                            }).appendTo(E);
        ...
        function(z) {
            if (z.shiftKey) {
                ...
                if (z.wheelDelta) if (z.wheelDelta >= 120) F.factor = 2;
                else {
                    if (z.wheelDelta <= -120) F.factor = 0.5
                } else if (z.detail) if (z.detail > 0) F.factor = 0.5;
        ...
        return {
                    ...
                    if (A) {
                        ...
                        if (E) {
                            if (q <= 1 && K >= 2) {
                                ...
                                D = D.pathSegType === 4 ? A.createSVGPathSegLinetoAbs(F, z) : A.createSVGPathSegCurvetoCubicAbs(F, z, D.x1 / v, D.y1 / v, q, E);
                            ...
                            Ga = false;
                            if (f) {
                                svgedit.path.path.matrix && Za(u, {},
                                svgedit.path.path.matrix.inverse());
                                F = u.getAttribute("d");
            ...
            mouseMove: function(D, z, F) {
                ...
                if (Ea === "path") {
                    ...
                    q = D.x - n.x;
                    n = D.y - n.y;
                    svgedit.path.path.dragging = [z, F]; ! k || !svgedit.path.is_linked ? svgedit.path.setLinkControlPoints(false) : svgedit.path.setLinkControlPoints(true);
            ...
            mouseUp: function(D, z, F, k) {
                ...
                if (svgedit.path.path.dragging) {
                    ...
                    G && svgedit.path.path.endChanges("Move path point(s)"); ! D.shiftKey && !G && svgedit.path.path.selectPt(z)
            ...
            clonePathNode: function() {
                svgedit.path.path.storeD();
                for (var D = svgedit.path.path.selected_pts,
                z = D.length,
                F = []; z--;) {
                    var k = D[z];
                ...
                if (D.length === 1) {
                    ...
                    if (n !== false) {
                        ...
                        if (n == svgedit.path.path.segs.length) {
                            ...
                            svgedit.path.insertItemBefore(z, u, n)
                        }
            ...
            deletePathNode: function() {
                if (Ha.canDeleteNodes) {
                    svgedit.path.path.storeD();
                    for (var D = svgedit.path.path.selected_pts,
                    z = D.length; z--;) svgedit.path.path.deleteSeg(D[z]);
                    var F = function() {
                        ...
                        for (; n--;) {
                            ...
                            if (u.pathSegType === 1) {
                                ...
                                if (u === 2) {
                                    ...
                                    F();
                                    break
                                } else if (u === 1 && k.numberOfItems - 1 === n) {
                                    q(n, 1);
                                    F();
                                    break
                                }
    ...
    yb = this.removeUnusedDefElems = function() {
        ...
        for (var h = [], m = 0, B = ["fill", "stroke", "filter", "marker-start", "marker-mid", "marker-end"], A = B.length, G = p.getElementsByTagNameNS(b, "*"), D = G.length, z = 0; z < D; z++) {
    ...
    this.svgCanvasToString = function() {
        ...
        $(p).find("g:data(gsvg)").each(function() {
            for (var m = this.attributes,
            B = m.length,
            A = 0; A < B; A++) if (m[A].nodeName == "id" || m[A].nodeName == "style") B--;
            if (B <= 0) {
                m = this.firstChild;
                f.push(m);
                $(this).replaceWith(m)
        ...
        if (f) {
            ...
            if (f.id === "svgcontent") {
                ...
                for (F = D.length - 1; F >= 0; F--) {
                    z = D.item(F);
                    q = B(z.nodeValue);
                    if (! (u.indexOf(z.localName) >= 0)) if (q != "") if (q.indexOf("pointer-events") !== 0) if (! (z.localName === "class" && q.indexOf("se_") === 0)) {
                        m.push(" ");
    ...
    Lb = this.convertToGroup = function(f) {
        ...
        if (h.data("gsvg")) {
            ...
            for (var D = f.childNodes,
            z = 0; z < D.length; z++) h.appendChild(D[z].cloneNode(true));
            ...
            B = f.parentNode;
            Hb(h);
            svgedit.browser.isGecko() && $(gb()).append($(h).find("linearGradient,radialGradient,pattern"));
            h.id = ja();
            A.after(h);
            if (B) {
                if (!G) {
            ...
            svgedit.utilities.walkTreePost(h,
            function(F) {
                try {
                    Qa(F)
                } catch(k) {
            ...
            rb([h]); (f = Db(h, true)) && m.addSubCommand(f);
            xa(m)
    ...
    this.setSvgString = function(f) {
        try {
            ...
            Gb(G);
            Ib(G[0]);
            svgedit.utilities.walkTreePost(p,
            function(K) {
                try {
                    Qa(K)
                } catch(O) {
    ...
    this.importSvgString = function(f) {
        try {
            ...
            O.id = ja();
            Z(O, "#" + A.id); (L || C().getCurrentLayer()).appendChild(O);
    ...
    this.setCurrentLayer = function(f) { (f = C().setCurrentLayer(svgedit.utilities.toXml(f))) && ya();
        return f
    };
    this.renameCurrentLayer = function(f) {
        ...
        if (h.current_layer) {
            ...
            if (!c.setCurrentLayer(f)) {
                ...
                h.all_layers[A][0] = svgedit.utilities.toXml(f);
    ...
    this.moveSelectedToLayer = function(f) {
        for (var h = null,
        m = C(), B = 0; B < m.getNumLayers(); ++B) if (m.getLayerName(B) == f) {
            h = m.all_layers[B][1];
            break
        }
        if (!h) return false;
    ...
    this.mergeLayer = function(f) {
        ...
        if (B) {
            for (h.addSubCommand(new Ia(m.current_layer, m.current_layer.nextSibling, p)); m.current_layer.firstChild;) {
    ...
    this.mergeAllLayers = function() {
        ...
        h = C();
        for (h.current_layer = h.all_layers[h.getNumLayers() - 1][1]; $(p).children("g").length > 1;) f.addSubCommand(c.mergeLayer(true));
        ya();
        xb();
        M("changed", [p]);
        xa(f)
    ...
    this.setDocumentTitle = function(f) {
        ...
        m = false,
        B = "",
        A = new Ba("Change Image Title"), G = 0; G < h.length; G++) if (h[G].nodeName == "title") {
            m = h[G];
            B = m.textContent;
            break
        }
    ...
    this.setBBoxZoom = function(f, h, m) {
        ...
        A = function(G) {
            if (!G) return false;
            var D = Math.min(Math.round(h / G.width * 100 * B) / 100, Math.round(m / G.height * 100 * B) / 100);
            c.setZoom(D);
            return {
                zoom: D,
                bbox: G
    ...
    Mb = function(f) {
        ...
        B = ["r", "cx", "cy", "fx", "fy"]; m--;) {
            ...
            if (f.tagName == "linearGradient") {
                if (f.getAttribute("x1") != A.getAttribute("x1") || f.getAttribute("y1") != A.getAttribute("y1") || f.getAttribute("x2") != A.getAttribute("x2") || f.getAttribute("y2") != A.getAttribute("y2")) continue
            } else {
                var G = $(f).attr(B),
                D = $(A).attr(B),
                z = false;
    ...
    this.setStrokeWidth = function(f) {
        if (f == 0 && ["line", "path"].indexOf(Ea) >= 0) c.setStrokeWidth(1);
            ...
            for (var h = [], m = H.length; m--;) {
                var B = H[m];
                if (B) B.tagName == "g" ? svgedit.utilities.walkTree(B,
                function(A) {
    ...
    this.setBold = function(f) {
        ...
        h.forEach(function(m) {
            if (m != null && m.tagName == "text") Ya("font-weight", f ? "bold": "normal")
        });
    ...
    this.convertToPath = function(f, h) {
        ...
        function(aa, S) {
            ...
            $.each(["marker-start", "marker-end", "marker-mid", "filter", "clip-path"],
            function() {
            ...
            case "rect":
                ...
                K = K.height;
                n = 4 - n;
                if (!I && !q) k([["M", [u, E]], ["L", [u + O, E]], ["L", [u + O, E + K]], ["L", [u, E + K]], ["L", [u, E]], ["Z", []]]);
                else {
                    q || (q = I);
    ...
    var Ab = this.changeSelectedAttributeNoUndo = function(f, h, m) {
        ...
        A = ["g", "polyline", "path"]; B--;) {
            var G = m[B];
            if (G != null) {
                Ea === "textedit" && f !== "#text" && G.textContent.length && bb.toSelectMode(G);
                if ((f === "x" || f === "y") && A.indexOf(G.tagName) >= 0) {
                    ...
                    if (D !== String(h)) {
                        ...
                        0);
                        D = pa(G);
                        if (D != 0 && f != "transform") for (var z = R(G), F = z.numberOfItems; F--;) if (z.getItem(F).type == 4) {
                            z.removeItem(F);
        ...
        if (h) {
            for (var m = [], B = new Ba("Paste elements"); h--;) {
                ...
                if (A) {
                    ...
                    m.push(G); (L || C().getCurrentLayer()).appendChild(G);
    ...
    this.ungroupSelectedElement = function() {
        ...
        if ($(f).data("gsvg") || $(f).data("symbol")) Lb(f);
            ...
            if (f.tagName === "g" || f.tagName === "a") {
                ...
                m && h.addSubCommand(m);
                m = f.parentNode;
                for (var B = f.nextSibling,
                A = Array(f.childNodes.length), G = 0; f.firstChild;) {
                    var D = f.firstChild,
                    z = D.nextSibling,
                    F = D.parentNode;
                    if (D.tagName === "title") {
    ...
    this.moveToBottomSelectedElement = function() {
        ...
        f.forEach(function(m) {
            ...
            if (A != m.nextSibling) {
                h.addSubCommand(new Na(m, A, B, "bottom"));
                M("changed", [m])
            }
        });
        h.isEmpty() || xa(h)
    ...
    this.moveSelectedElements = function(f, h, m) {
        ...
        for (var B = new Ba("position"), A = H.length; A--;) {
            ...
            if (G != null) {
                ...
                z.numberOfItems ? z.insertItemBefore(D, 0) : z.appendItem(D); (D = Qa(G)) && B.addSubCommand(D);
    ...
    this.cloneSelectedElements = function(f, h, m) {
        for (var B = new Ba("Clone Elements"), A = H.length, G = 0; G < A; ++G) {
            var D = H[G];
            if (D == null) break
        }
        A = H.slice(0, G);
    ...
    if (!window.methodDraw) window.methodDraw = function(a) {
        function o(d, p) {
            ...
            p = p || a.noop;
            w ? p(true) : a.alert(uiStrings.notification.errorLoadingSVG,
            function() {
                p(false)
            })
        }
        ...
        b.init = function() { (function() {
            ...
            var d = function() {
                a.each(curConfig.extensions,
                function() {
                    var k = this;
                    a.getScript(curConfig.extPath + k,
                    function(n) {
                        if (!n) {
            ...
            a("#base_unit_container").on("mouseleave mouseenter",
            function() {
            ...
            d || a(".shortcut").each(function() {
                ...
                q = function(u, E, I, K) {
                    ...
                    u != "alert" && a('<input type="button" value="' + uiStrings.common.cancel + '">').appendTo(n).on("click touchstart",
                    function() {
                        k.hide();
                        I(false)
                    });
            ...
            a("#cur_context_panel").delegate("a", "click",
            function() {
                var k = a(this);
            ...
            da = function(k) {
                ...
                function(n, q) {
                    ...
                    u.addClass("tool_button").unbind("click mousedown mouseup").each(function(aa) {
                        ...
                        aa = function(ea) {
                            ...
                            if (ea.type === "keydown") {
                                ...
                                a.each(k[S.parent],
                                function(za, Aa) {
                                    if (Aa.sel == qa) ga = !ea.shiftKey || !T ? Aa: k[S.parent][za + 1] || k[S.parent][0]
                                })
                            }
                    ...
                    else I.attr("data-curopt") || I.attr("data-curopt", q[0].sel);
            ...
            if (curConfig.baseUnit !== "px") {
                ...
                Fa.h = svgedit.units.convertUnit(Fa.h) + curConfig.baseUnit
            }
            var Na = function(k) {
            ...
            Ia = function() {
                ...
                if (E) {
                    ...
                    zb("#tool_openclose_path", C.closed_subpath ? "open_path": "close_path");
                    if (n) {
                        E = a("#seg_type");
                        if (u) {
                    ...
                    if (W) {
                        W = W.filter(Boolean); (k = e.elementsAreSame(W) ? W[0] : null) && a("#tools_top").addClass("multiselected")
                    }
                    if (!k && !W) {
                        a("#tools_top").removeClass("multiselected");
                        a("#stroke_panel").hide();
            ...
            function(k, n) {
                ...
                if (X != null) {
                    ...
                    W.length && a("#tools_top").addClass("multiselected")
                } else if (W.length) {
                    a(".context_panel").hide();
                    a("#tools_top").removeClass("multiselected");
                    a("#multiselected_panel").show()
            ...
            function(k, n) {
                ...
                O = [];
                n.context_tools && a.each(n.context_tools,
                function(ga, T) {
                    ...
                    case "tool_button":
                        ...
                        Aa = a(za).appendTo(va);
                        T.events && a.each(T.events,
                        function(La, jb) {
                            a(Aa).bind(La, jb)
                        });
                        break;
                    case "select":
                        za = "<label" + qa + '><select id="' + T.id + '">';
                        a.each(T.options,
                        function(La, jb) {
                    ...
                    case "button-select":
                        ...
                        T.colnum && qa.addClass("optcols" + T.colnum);
                ...
                if (n.buttons) {
                    ...
                    function(ga, T) {
                        for (var qa, va = T.id,
                        za = ga; a("#" + va).length;) va = T.id + "_" + ++za;
                        if (S) {
                            V[va] = T.icon;
                        ...
                        if (!T.includeWith && !T.list) {
                            ...
                            if (T.type == "mode_flyout") {
                                ...
                                if (!za.parent().hasClass("tools_flyout")) {
                                    var La = za[0].id.replace("tool_", "tools_"),
                        ...
                        S || Pa.append(qa);
                        T.list || a.each(T.events,
                        function(Cb, Jb) {
                            if (Cb == "click") if (T.type == "mode") {
                                T.includeWith ? Pa.bind(Cb, Jb) : Pa.bind(Cb,
                                function() {
                                    ra(Pa) && Jb()
                                });
                                if (T.key) {
            ...
            changeAttribute = function(k) {
                ...
                q = parseFloat(q);
                q = k.value * q;
                if (!svgedit.units.isValidUnit(n, q, X)) {
            ...
            a("#palette").on("mousemove mousedown touchstart touchmove", ".palette_item",
            function(k) {
                k.preventDefault();
            ...
            var ra = function(k, n) {
                ...
                u = false,
                E = false;
                a("#svgcanvas").on("mousemove mouseup touchend",
                function(I) {
                    if (u !== false) {
            ...
            a(".menu_item").on("mousedown touchstart",
            function(k) {
                kb(k)
            });
            a("svg, body").on("mousedown  touchstart",
            function(k) {
            ...
            b.addDropDown = function(k, n, q) {
                if (a(k).length != 0) {
                    ...
                    E = a(k).find("ul").attr("id", a(k)[0].id + "-list");
            ...
            a("div", "#position_opts").each(function() {
                ...
                function() {
                    var k = this.id.replace("tool_pos", "").charAt(0);
            ...
            Ma = function() {
                ...
                a.confirm(uiStrings.notification.QwantToClear,
                function(n) {
                    if (n) {
                        la();
                        e.clear();
            ...
            nb = function() {
                ...
                window.canvg ? e.rasterExport() : a.getScript("canvg/rgbcolor.js",
                function() {
                    a.getScript("canvg/canvg.js",
                    function() {
                        e.rasterExport()
                    })
                })
            ...
            Hb = function() {
                ya(a("#view_menu")); ! a("#tool_wireframe").hasClass("push_button_pressed") ? a("#tool_wireframe").addClass("push_button_pressed") : a("#tool_wireframe").removeClass("push_button_pressed");
            ...
            xb = function() {
                if (!h) {
                    var k = "#workarea.wireframe #svgcontent * { stroke-width: " + 1 / e.getZoom() + "px; }";
                    ...
                    if (k != "m") {
                        ...
                        function(K, O) {
                            ...
                            function(V, aa) {
                                ...
                                else if (aa[k] || aa.all) S = aa[k] || aa.all;
                                I += V + ":" + S + ";"
                            });
                            I += "}"
                        });
            ...
            Ab = function() {
                a("#dialog_box").hide();
                if (fa) {
                    if (fa) ca !== a("#svg_source_textarea").val() ? a.confirm(uiStrings.notification.QignoreSourceChanges,
                    function(k) {
                        k && Ya()
                    }) : Ya();
                    Db()
            ...
            a("#change_image_url").click(function() {
                ...
                a.prompt(uiStrings.notification.enterNewImgURL, k,
                function(n) {
                    n && Sa(n)
                })
            });
            ...
            d = function(k, n) {
                ...
                n === "canvas" ? q.setAttribute("width", 60.5) : q.setAttribute("width", "100%");
                ...
                this.setPaint = function(E, I) {
                    ...
                    case "radialGradient":
                        ...
                        K = "url(#" + (this.grad.id = "gradbox_" + this.type) + ")"
                    }
                ...
                this.update = function(E) {
                    if (X) {
                        ...
                        case "a":
                            for (var K = null,
                            O = X.getElementsByTagName("*"), V = 0, aa = O.length; V < aa; V++) {
            ...
            d = b.paintBox.fill.rect.ownerDocument.createElementNS("http://www.w3.org/2000/svg", "feGaussianBlur");
            typeof d.stdDeviationX === "undefined" && a("#tool_blur").hide();
            a(d).remove();
            setTimeout(function() {
                e.embedImage("images/placeholder.svg",
                function(k) {
                    if (!k) {
            ...
            a("#tool_canvas").on("click touchstart",
            function() {
                f(a("#canvas_color"))
            });
            a("#tool_stroke").on("touchstart",
            function() {
                a("#tool_stroke").addClass("active");
                a("#tool_fill").removeClass("active");
                f(a("#stroke_color"))
            });
            a("#tool_fill").on("touchstart",
            function() {
                a("#tool_fill").addClass("active");
                a("#tool_stroke").removeClass("active");
                f(a("#fill_color"))
            });
            a("#zoom_select").on("change",
            function() {
                        ...
                        function(u, E) {
                            ...
                            if (E.key) {
                                ...
                                if (E.sel && !E.hidekey && I.attr("title")) {
                                    ...
                                    n[K] = E.sel;
                                    I.parents("#main_menu").length || I.attr("title", aa)
                                }
                            }
                        });
                        da(q);
                        a(window).bind("keydown", "tab",
                        function(u) {
                            if (N === "canvas") {
                                u.preventDefault();
                                P()
                            }
                        }).bind("keydown", "shift+tab",
                        function(u) {
                            if (N === "canvas") {
                                u.preventDefault();
                                ba()
            ...
            b.ready(function() {
                ...
                q = n.find("#tool_" + k);
                k = n.find("#" + k); (q.length ? q: k.length ? k: a("#tool_select")).click().mouseup();
            ...
            a("#stroke_width").dragInput({
                ...
                callback: function(k) {
                    var n = k.value;
                    if (n == 0 && X && ["line", "polyline"].indexOf(X.nodeName) >= 0) n = k.value = 1;
                    e.setStrokeWidth(n)
                },
                cursor: true,
                smallStep: 0.1,
            ...
            if (window.FileReader) {
                ...
                J = a("#workarea");
                J[0].addEventListener("dragenter",
                function(k) {
                    k.stopPropagation();
                    k.preventDefault();
                    J.css({
                ...
                false);
                J[0].addEventListener("dragover",
                function(k) {
                    k.stopPropagation();
                    k.preventDefault()
                },
                false);
                J[0].addEventListener("dragleave",
                function(k) {
                    J.removeAttr("style");
                    k.stopPropagation();
                    k.preventDefault()
            ...
            var G = b.updateCanvas = function(k, n) {
                ...
                q == E && u == I ? J.css("overflow", "hidden") : J.css("overflow", "scroll");
                S = V.height() / 2;
                var ea = V.width() / 2;
                V.width(q).height(u);
                var ga = u / 2,
                ...
                if (curConfig.showRulers) {
                    ...
                    for (V = 0; V < 2; V++) {
                        ...
                        qa.fillStyle = "#777";
                        for (var La = S / va % q * va,
                        jb = La - Pa; La < ga; La += Pa) {
                            jb += Pa;
                            u = Math.round(La) + 0.5;
                            if (aa) {
                                qa.moveTo(u, 15);
            ...
            try {
                var z = function(k) {
                    ...
                    else if (typeof k == "string") return '"' + k.replace(/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
                    function(E) {
                        return "\\u" + ("0000" + E.charCodeAt(0).toString(16)).slice( - 4)
                    }) + '"';
                    else if (k.length) {
                        for (var q = 0; q < k.length; q++) k[q] = n(k[q]);
                        return "[" + k.join(",") + "]"
                    } else {
                        q = [];
...
$.fn.dragInput = function(a) {
    return this.each(function() {
        ...
        this.dragCfg.smallStep = a && a.smallStep ? a.smallStep: this.dragCfg.step / 2;
        ...
        this.launch = function(H) {
            ...
            e.addClass("active");
            $(window).bind("mousemove.draginput touchmove.draginput",
            function(la) {
                ca.move(la, R, parseFloat(N))
            });
            $(window).bind("mouseup.draginput touchend.draginput",
            function() {
                ca.stop()
            })
        };
        $(this).attr("readonly", "readonly").attr("data-scale", p).attr("data-domain", l).attr("data-cursor", J != false).bind("mousedown touchstart",
        function(H) {
            this.blur();
            this.launch(H)
...
svgedit = svgedit || {}; (function() {
    ...
    svgedit.contextmenu.add = function(o) {
        if (o && o.id && o.label && o.action && typeof o.action == "function") if (o.id in a.contextMenuExtensions) console.error('Cannot add extension "' + o.id + '", an extension by that name already exists"');
        else {
    ...
    svgedit.contextmenu.hasCustomHandler = function(o) {
    ...
    function(l, s) {
        ...
        plugin: {
            ...
            call: function(l, s, c) {
                if ((s = l.plugins[s]) && l.element[0].parentNode) for (var g = 0; g < s.length; g++) l.options[s[g][0]] && s[g][1].apply(l.element, c)
            }
        },
        ...
        isOver: function(l, s, c, g, d, p) {
            return a.ui.isOverAxis(l, c, d) && a.ui.isOverAxis(s, g, p)
        }
    }))
})(jQuery); (function(a, o) {
    if (a.cleanData) {
    ...
    a.widget.bridge = function(l, s) {
        a.fn[l] = function(c) {
            ...
            p = this;
            c = !g && d.length ? a.extend.apply(null, [true, c].concat(d)) : c;
    ...
    a.Widget.prototype = {
        ...
        _createWidget: function(l, s) {
            ...
            this.options, this._getCreateOptions(), l);
            var c = this;
        ...
        _setOption: function(l, s) {
            this.options[l] = s;
            l === "disabled" && this.widget()[s ? "addClass": "removeClass"](this.widgetBaseClass + "-disabled ui-state-disabled").attr("aria-disabled", s);
            return this
        },
        enable: function() {
    ...
    a.widget("ui.mouse", {
        ...
        _mouseDown: function(e) {
            if (!o) {
                ...
                if (!l || s || !this._mouseCapture(e)) return true; (this.mouseDelayMet = !this.options.delay) || (this._mouseDelayTimer = setTimeout(function() {
        ...
        _mouseUp: function(e) {
            ...
            this._mouseStarted && (this._mouseStarted = false, e.target == this._mouseDownEvent.target && a.data(e.target, this.widgetName + ".preventClickEvent", true), this._mouseStop(e));
            return false
        },
    ...
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _getParentOffset: function() {
            ...
            return {
                ...
                left: o.left + (parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0)
            }
        },
        ...
        _convertPositionTo: function(o, e) {
            ...
            return {
                top: e.top + this.offset.relative.top * b + this.offset.parent.top * b - (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : s ? 0 : l.scrollTop()) * b),
        ...
        _generatePosition: function(o) {
            ...
            if (this.originalPosition) {
                ...
                if (e.grid) {
                    ...
                    s = e.grid[0] ? this.originalPageX + Math.round((s - this.originalPageX) / e.grid[0]) * e.grid[0] : this.originalPageX;
            ...
            return {
                ...
                left: s - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : l ? 0 : b.scrollLeft())
            }
        },
        _clear: function() {
        ...
        _trigger: function(o, e, b) {
            ...
            return a.Widget.prototype._trigger.call(this, o, e, b)
        },
        plugins: {},
        _uiHash: function() {
            return {
    ...
    a.ui.plugin.add("draggable", "opacity", {
        start: function(o, e) {
            ...
            b.css("opacity") && (l._opacity = b.css("opacity"));
    ...
    a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(o) {
            ...
            if (e.scrollParent[0] != document && e.scrollParent[0].tagName != "HTML") {
                if (!b.axis || b.axis != "x") e.overflowOffset.top + e.scrollParent[0].offsetHeight - o.pageY < b.scrollSensitivity ? e.scrollParent[0].scrollTop = l = e.scrollParent[0].scrollTop + b.scrollSpeed: o.pageY - e.overflowOffset.top < b.scrollSensitivity && (e.scrollParent[0].scrollTop = l = e.scrollParent[0].scrollTop - b.scrollSpeed);
                if (!b.axis || b.axis != "y") e.overflowOffset.left + e.scrollParent[0].offsetWidth - o.pageX < b.scrollSensitivity ? e.scrollParent[0].scrollLeft = l = e.scrollParent[0].scrollLeft + b.scrollSpeed: o.pageX - e.overflowOffset.left < b.scrollSensitivity && (e.scrollParent[0].scrollLeft = l = e.scrollParent[0].scrollLeft - b.scrollSpeed)
            } else {
                ...
                if (!b.axis || b.axis != "y") o.pageX - a(document).scrollLeft() < b.scrollSensitivity ? l = a(document).scrollLeft(a(document).scrollLeft() - b.scrollSpeed) : a(window).width() - (o.pageX - a(document).scrollLeft()) < b.scrollSensitivity && (l = a(document).scrollLeft(a(document).scrollLeft() + b.scrollSpeed))
            }
    ...
    a.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(o, e) {
            for (var b = a(this).data("draggable"), l = b.options, s = l.snapTolerance, c = e.offset.left, g = c + b.helperProportions.width, d = e.offset.top, p = d + b.helperProportions.height, w = b.snapElements.length - 1; w >= 0; w--) {
                ...
                if (C - s < c && c < v + s && L - s < d && d < Q + s || C - s < c && c < v + s && L - s < p && p < Q + s || C - s < g && g < v + s && L - s < d && d < Q + s || C - s < g && g < v + s && L - s < p && p < Q + s) {
                    if (l.snapMode != "inner") {
                    ...
                    } ! b.snapElements[w].snapping && (J || H || U || R || N) && b.options.snap.snap && b.options.snap.snap.call(b.element, o, a.extend(b._uiHash(), {
    ...
    a.ui.plugin.add("draggable", "stack", {
        start: function() {
            var o = a(this).data("draggable").options;
            o = a.makeArray(a(o.stack)).sort(function(b, l) {
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function() {
            ...
            this.handles.keydown(function(g) {
                ...
                if (!o.options.disabled) {
                    ...
                    w = o.options.step;
                    o.options.values && o.options.values.length ? C = v = o.values(p) : C = v = o.value();
                    switch (g.keyCode) {
                    case a.ui.keyCode.HOME:
                        v = o._valueMin();
                        break;
        ...
        _normValueFromMouse: function(o) {
            var e, b;
            this.orientation === "horizontal" ? (e = this.elementSize.width, b = o.x - this.elementOffset.left - (this._clickOffset ? this._clickOffset.left: 0)) : (e = this.elementSize.height, b = o.y - this.elementOffset.top - (this._clickOffset ? this._clickOffset.top: 0));
            o = b / e;
            o > 1 && (o = 1);
            o < 0 && (o = 0);
        ...
        _refreshValue: function() {
            ...
            e.animate), o === "max" && this.orientation === "horizontal" && this.range[l ? "animate": "css"]({
                width: 100 - s + "%"
            },
            {
                queue: false,
    ...
    e = function(c, g, d, p) {
        ...
        ca = function(ia) {
            if (! (ia.target.value == "" && ia.target != R.get(0) && (d != null && ia.target != d.get(0) || d == null))) {
                ...
                case L.get(0):
                    ...
                    break;
                case Q && Q.get(0) : switch (ia.keyCode) {
                    case 38:
        ...
        la = function(ia) {
            if (! (ia.target.value == "" && ia.target != R.get(0) && (d != null && ia.target != d.get(0) || d == null))) {
                ...
                case L.get(0):
                    ...
                    g.val("b", L.val(), ia.target);
                    break;
                case Q && Q.get(0) : Q.val(fa.call(w, Q.val(), 0, 100));
                    g.val("a", Math.precision(Q.val() * 255 / 100, p), ia.target);
                    break;
                case J.get(0):
                    J.val(fa.call(w, J.val(), 0, 360));
                    g.val("h", J.val(), ia.target);
                    break;
                case H.get(0):
                ...
                case R.get(0):
                    ...
                    break;
                case d && d.get(0) : d.val(d.val().replace(/[^a-fA-F0-9]/g, "").toLowerCase().substring(0, 6));
                    R.val(d.val());
                    g.val("hex", d.val() != "" ? d.val() : null, ia.target);
                    break;
                case N && N.get(0) : N.val(N.val().replace(/[^a-fA-F0-9]/g, "").toLowerCase().substring(0, 2));
        ...
        X = function(ia) {
            ...
            case L.get(0):
                L.val(g.val("b"));
                break;
            case Q && Q.get(0) : Q.val(Math.precision(g.val("a") * 100 / 255, p));
                break;
            case J.get(0):
                J.val(g.val("h"));
                break;
            ...
            case U.get(0):
                ...
                break;
            case R.get(0):
            case d && d.get(0) : R.val(g.val("hex"));
                d && d.val(g.val("hex"));
                break;
            case N && N.get(0) : N.val(g.val("ahex").substring(6))
            }
        },
        W = function(ia) {
            switch (ia.keyCode) {
        ...
        ta = function(ia, ka) {
            ...
            if (ka != v.get(0)) v.val(Z != null ? Z.g: "");
        ...
        a.extend(true, w, {
            destroy: function() {
                C.add(v).add(L).add(Q).add(J).add(H).add(U).add(R).add(d).add(N).unbind("keyup", la).unbind("blur", X);
    ...
    a.jPicker = {
        ...
        Color: function(c) {
            ...
            if (c) if (c.ahex != null) U("ahex", c);
            else if (c.hex != null) U((c.a != null ? "a": "") + "hex", c.a != null ? {
                ahex: c.hex + s.intToHex(c.a)
            }: c);
            else if (c.r != null && c.g != null && c.b != null) U("rgb" + (c.a != null ? "a": ""), c);
        ...
        return this.each(function() {
            ...
            vb = function(M) {
                ...
                case "v":
                    ...
                    break;
                case "r":
                    ua.call(d, J, Math.precision((M.val("r") || 0) / 255 * 100, 4));
                    break;
                case "g":
            ...
            cb = function(M) {
                ...
                case "s":
                    ...
                    ua.call(d, R, 100 - (P != null ? P.v: 100));
                ...
                case "b":
                    ...
                    var Ca = ba > P ? P: ba;
                    ua.call(d, R, P > ba ? Math.precision((P - ba) / (255 - ba) * 100, 4) : 0);
            ...
            ua = function(M, P) {
                ...
                if (P > 0 && P < 100) if (w) {
                    ...
                    ba != null && (ba.indexOf("AlphaBar.png") != -1 || ba.indexOf("Bars.png") != -1 || ba.indexOf("Maps.png") != -1) ? M.css({
                        filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + ba + "', sizingMethod='scale') progid:DXImageTransform.Microsoft.Alpha(opacity=" + P + ")"
                    }) : M.css({
            ...
            Xa = function(M) {
                ...
                ua.call(d, oa, Math.precision((M.val("a") || 0) * 100 / 255, 4))
            },
            wb = function(M) {
                var P = M.val("hex");
                M = M.val("va");
            ...
            pb = function() {
                ...
                case "fade":
                    C.fadeIn(p.window.effects.speed.show, M);
                    break;
                case "slide":
            ...
            tb = function() {
                var M = p.window,
                P = M.expandable ? a(d).next().find(".Container:first") : null;
                ...
                var Ca = '<table class="jPicker" cellpadding="0" cellspacing="0"><tbody>' + (M.expandable ? '<tr><td class="Move" colspan="5">&nbsp;</td></tr>': "") + '<tr><td rowspan="9"><h2 class="Title">' + (M.title || Y.text.title) + '</h2><div class="Map"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><img src="' + ha.clientPath + ha.colorMap.arrow.file + '" class="Arrow"/></div></td><td rowspan="9"><div class="Bar"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><span class="Map4">&nbsp;</span><span class="Map5">&nbsp;</span><span class="Map6">&nbsp;</span><img src="' + ha.clientPath + ha.colorBar.arrow.file + '" class="Arrow"/></div></td><td colspan="2" class="Preview"><div class="prev_div">' + Y.text.newColor + '<div class="color_preview"><span class="Active" title="' + Y.tooltips.colors.newColor + '">&nbsp;</span><span class="Current" title="' + Y.tooltips.colors.currentColor + '">&nbsp;</span></div></div>' + Y.text.currentColor + '</td><td rowspan="9" class="Button"><input type="button" class="Ok" value="' + Y.text.ok + '" title="' + Y.tooltips.buttons.ok + '"/><input type="button" class="Cancel" value="' + Y.text.cancel + '" title="' + Y.tooltips.buttons.cancel + '"/><div class="Grid">&nbsp;</div></td></tr><tr class="Hue"><td class="Radio"><label title="' + Y.tooltips.hue.radio + '"><input type="radio" value="h"' + (p.color.mode == "h" ? ' checked="checked"': "") + '/>H:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (ba != null ? ba.h: "") + '" title="' + Y.tooltips.hue.textbox + '"/>&nbsp;\u00ba</td></tr><tr class="Saturation"><td class="Radio"><label title="' + Y.tooltips.saturation.radio + '"><input type="radio" value="s"' + (p.color.mode == "s" ? ' checked="checked"': "") + '/>S:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (ba != null ? ba.s: "") + '" title="' + Y.tooltips.saturation.textbox + '"/>&nbsp;%</td></tr><tr class="Value"><td class="Radio"><label title="' + Y.tooltips.value.radio + '"><input type="radio" value="v"' + (p.color.mode == "v" ? ' checked="checked"': "") + '/>V:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (ba != null ? ba.v: "") + '" title="' + Y.tooltips.value.textbox + '"/>&nbsp;%<br/><br/></td></tr><tr class="Red"><td class="Radio"><label title="' + Y.tooltips.red.radio + '"><input type="radio" value="r"' + (p.color.mode == "r" ? ' checked="checked"': "") + '/>R:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (ba != null ? ba.r: "") + '" title="' + Y.tooltips.red.textbox + '"/></td></tr><tr class="Green"><td class="Radio"><label title="' + Y.tooltips.green.radio + '"><input type="radio" value="g"' + (p.color.mode == "g" ? ' checked="checked"': "") + '/>G:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (ba != null ? ba.g: "") + '" title="' + Y.tooltips.green.textbox + '"/></td></tr><tr class="Blue"><td class="Radio"><label title="' + Y.tooltips.blue.radio + '"><input type="radio" value="b"' + (p.color.mode == "b" ? ' checked="checked"': "") + '/>B:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (ba != null ? ba.b: "") + '" title="' + Y.tooltips.blue.textbox + '"/></td></tr><tr class="Alpha"><td class="Radio">' + (M.alphaSupport ? '<label title="' + Y.tooltips.alpha.radio + '"><input type="radio" value="a"' + (p.color.mode == "a" ? ' checked="checked"': "") + "/>A:</label>": "&nbsp;") + '</td><td class="Text">' + (M.alphaSupport ? '<input type="text" maxlength="' + (3 + M.alphaPrecision) + '" value="' + (ba != null ? Math.precision(ba.a * 100 / 255, M.alphaPrecision) : "") + '" title="' + Y.tooltips.alpha.textbox + '"/>&nbsp;%': "&nbsp;") + '</td></tr><tr class="Hex"><td colspan="2" class="Text"><label title="' + Y.tooltips.hex.textbox + '">#:<input type="text" maxlength="6" class="Hex" value="' + (ba != null ? ba.hex: "") + '"/></label>' + (M.alphaSupport ? '<input type="text" maxlength="2" class="AHex" value="' + (ba != null ? ba.ahex.substring(6) : "") + '" title="' + Y.tooltips.hex.alpha + '"/></td>': "&nbsp;") + "</tr></tbody></table>";
                if (M.expandable) {
                    C.html(Ca);
                    ...
                    C.css({
                        left: M.position.x == "left" ? P.offset().left - 530 - (M.position.y == "center" ? 25 : 0) + "px": M.position.x == "center" ? P.offset().left - 260 + "px": M.position.x == "right" ? P.offset().left - 10 + (M.position.y == "center" ? 25 : 0) + "px": M.position.x == "screenCenter" ? (a(document).width() >> 1) - 260 + "px": P.offset().left + parseInt(M.position.x) + "px",
                        position: "absolute",
                ...
                fa = new o(L, {
                    ...
                    arrow: {
                        image: ha.clientPath + ha.colorBar.arrow.file,
                ...
                ma = Wa.find(".Ok:first").bind("click touchstart", lb);
                ...
                setTimeout(function() {
                    ...
                    Va.call(d, Za.find("div:last"), ha.clientPath + "preview-opacity.png")
                },
                0);
                ...
                if (ja.quickList && ja.quickList.length > 0) {
                    ...
                    for (i = 0; i < ja.quickList.length; i++) {
                        ...
                        Wa += '<span class="QuickColor"' + (Qa && ' title="#' + Qa + '"' || "") + ' style="background-color:' + (mb && "#" + mb || "") + ";" + (mb ? "": "background-image:url(" + ha.clientPath + "NoColor.png)") + (M.alphaSupport && nb && nb < 255 ? ";opacity:" + Math.precision(nb / 255, 4) + ";filter:Alpha(opacity=" + Math.precision(nb / 2.55, 4) + ")": "") + '">&nbsp;</span>'
                    }
    ...
    if (a.event.fixHooks) for (var b = e.length; b;) a.event.fixHooks[e[--b]] = a.event.mouseHooks;
    a.event.special.mousewheel = {
        setup: function() {
            if (this.addEventListener) for (var l = e.length; l;) this.addEventListener(e[--l], o, false);
            else this.onmousewheel = o
        },
        teardown: function() {
            if (this.removeEventListener) for (var l = e.length; l;) this.removeEventListener(e[--l], o, false);
...
methodDraw.addExtension("eyedropper",
function(a) {
    ...
    return {
        name: "eyedropper",
        svgicons: "https://cdn.jsdelivr.net/gh/caly5144/CDN/tool/svg/extensions/eyedropper-icon.xml",
        buttons: [{
            id: "tool_eyedropper",
            type: "mode",
            ...
            position: 8,
            key: "I",
            icon: "https://cdn.jsdelivr.net/gh/caly5144/CDN/tool/svg/extensions/eyedropper.png",
            events: {
                click: function() {
        ...
        mouseDown: function(s) {
            ...
            if (c == "eyedropper" && g) {
                ...
                b.fillOpacity = g.getAttribute("fill-opacity") || 1;
                ...
                if (s.selectedElements.length) {
                    if ($.inArray(s.selectedElements.nodeName, ["g", "use"]) == -1) {
                        ...
                        s.selectedElements.forEach(function(C) {
                            ...
                            b.strokeLinejoin && p(C, "stroke-linejoin", b.strokeLinejoin);
...
methodDraw.addExtension("view_grid",
function(a) {
    function o(p) {
        g.attr("width");
        g.attr("height");
    ...
    if (!document.getElementById("canvasGrid")) {
        ...
        var c = e.createElementNS("http://www.w3.org/2000/svg", "g");
        a(c, {
            id: "canvasGrid",
            width: "100%",
            height: "100%",
...
methodDraw.addExtension("shapes",
function() {
    function a() {
        $("#shape_buttons").empty();
    ...
    function o(J) {
        ...
        if (H) {
            ...
            $.getJSON("https://cdn.jsdelivr.net/gh/caly5144/CDN/tool/svg/extensions/shapelib/" + J + ".json",
            function(U) {
                L = v[J] = {
                    data: U.data,
                    size: U.size,
    ...
    function e(J, H) {
        ...
        U = R ? 0 : U / 30;
        U = (new DOMParser).parseFromString('<svg xmlns="http://www.w3.org/2000/svg"><svg viewBox="' + N + '"><path fill="#333" stroke="transparent" stroke-width="' + U + '" /></svg></svg>', "text/xml");
    ...
    return {
        ...
        callback: function() {
            ...
            J.html(U).children().bind("mouseup",
            function() {
                var R = $(this);
    ...
    for (var a = 0,
    o = ["ms", "moz", "webkit", "o"], e = 0; e < o.length && !window.requestAnimationFrame; ++e) {
...
function(a) {
    if (! (typeof navigator !== "undefined" && /MSIE [1-9]\./.test(navigator.userAgent))) {
        ...
        c = function(L) { (a.setImmediate || a.setTimeout)(function() {
                throw L;
            },
            0)
        },
        ...
        C = function(L, Q, J) {
            ...
            la = function() {
                if (N && b && typeof FileReader !== "undefined") {
            ...
            if (e) {
                ...
                if (s) {
                    ...
                    s(a.TEMPORARY, g, X(function(ta) {
                        ta.root.getDirectory("saved", W, X(function(ia) {
                            var ka = function() {
...
else typeof define !== "undefined" && define !== null && define.amd != null && define([],
function() {
    return saveAs
});