...
//--------------------------------------------------
    ...
    $(function() {
        ...
        function valueOutput(element,e) {
            var value = element.value;
            var output = element.parentNode.getElementsByTagName('output')[0] || element.parentNode.parentNode.getElementsByTagName('output')[0];
              output[textContent] = value;
            var qrcodeid=$(e.target).attr('id');
			if (qrcodeid=='QRCode_Corner_Radius'){
				if (value<0){ canvasObj.changeRound(true, -(value)) }
				if (value>=0){ canvasObj.changeRound(false, value) }
				$('#CORNER_RADIUS').text(value);
			}
        }

        $document.on('input', 'input[type="range"], ' + selector, function(e) {
            valueOutput(e.target,e);
        ...
        $element.rangeslider({
            ...
            // Callback function
            onInit: function() {
                valueOutput(this.$element[0],this);
            },
