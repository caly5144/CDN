...
if (!this.JSON) {
  ...
  window.TOP = window.TOP || {
    ...
    guid: function (e) {
      e = e || 't';
      return e + (Math.random() * (1 << 30)).toString(16).replace('.', '')
    },
    log: function (f, e) {
      e = e || 'log';
  ...
  TOP.namespace('lang', {
    ...
    param: function (e, b, a) {
      ...
      for (var c in e) {
        var f = e[c];
        if (f !== null && typeof f !== 'undefined' && typeof f !== 'function') {
  ...
  var f = 'http://a.tbcdn.cn/apps/top/x/kio.swf',
  c = 'top-xdr';
  function d(j, m, i) {
    if (e.body) {
      var k = '<object id="' + c + '" type="application/x-shockwave-flash" data="' + j + '" width="0" height="0" ><param name="movie" value="' + j + '" /><param name="FlashVars" value="yid=' + m + '&uid=' + i + '&host=TOP.io.flashxdr" /><param name="allowScriptAccess" value="always" /></object>';
  ...
  TOP.namespace('io', {
    ...
    jsonp: function (h, j, f) {
      ...
      if (h.length > 2000) {
        b('JSONP only support a maximum of 2000 bytes of input.', 'error');
        return
      }
  ...
  TOP.namespace('cookie', {
    get: function (h) {
      ...
      f;
      if (b(h)) {
        if ((f = String(e.cookie).match(new RegExp('(?:^| )' + h + '(?:(?:=([^;]*))|;|$)')))) {
          g = f[1] ? d(f[1])  : ''
        }
      }
      return g
  ...
  TOP.namespace('fields', {
    ...
    getSdkScript: function () {
      var f = '.tbcdn.cn/apps/top/x/sdk.js',
      b = document.getElementsByTagName('script'),
      e;
      for (var g = b.length - 1; g >= 0; g--) {
        var d = b[g];
        var c = d && d.src && d.src.indexOf(f) >= 0;
        var h = d && d.src && d.src.indexOf('sdk.js') >= 0 && d.src.indexOf('daily=true') > 0;
        if (c || h) {
          e = d;
          getSdkScript = function () {
            return e
  ...
  if (window.location.href.indexOf(TOP.fields.uiUrl) == - 1 && window.location.href.indexOf(TOP.fields.noSignUiUrl) == - 1) {
  ...
  function b(m, l, k, j) {
    ...
    window.addEventListener ? m.addEventListener(l, k, false)  : m.attachEvent('on' + l, k)
  }
  function h(k, j, i) {
    window.addEventListener ? k.removeEventListener(j, i, false)  : k.detachEvent('on' + j, i)
  }
  var c = {
  };
  function e(m, l, k, j) {
  ...
  TOP.namespace('xd', {
    ...
    insertSwf: function () {
      TOP.ready(function () {
        ...
        swfobject.embedSWF(a.xdFlashUrl, 'top-xd-swf-box-' + k, '1', '1', '9.0.0', false, g, j, h, function (l) {
          if (!l.success) {
            alert('您当前的浏览器版本过低，请升级浏览器或安装flash播放器。');
            TOP.log('widget interaction need flash player or new browser.', 'error');
            return
          }
          TOP.xd.swfObj = l.ref
        })
  ...
  TOP.namespace('', {
    ...
    logout: function (l) {
      ...
      var m = [
        ...
        '?action=logout'
      ].join('').replace(/\${clientId}/g, e.appKey).replace(/\${redirectUrl}/g, e.channelUrl);
      if (a.ie) {
        window.location = m
      } else {
        window.open(m)
  ...
  TOP.namespace('', {
    api: function (r, p, w) {
      ...
      m,
      s = arguments,
      n = e.getNonce() ? h.noSignApiUrl : h.apiUrl;
      if (s.length > 3) {
        u = s[0];
        m = s[1];
        r = s[2];
  ...
  TOP.namespace('', {
    ui: function (h, f, i) {
      ...
      if (TOP.ui[h]) {
        ...
        d.getScript(a.uiUrl + '/' + h + '/' + e + '/' + h + '.js', function (k) {
          var l = TOP.ui[h](g, f);
          i && i(l)
        })
      }
  ...
  TOP.namespace('uihelper', {
    iframe: function (o, m) {
      if (!o || !m || !m.url) {
        f('guid and cfg.url is required in TOP.uihelper.iframe().', 'error');
        return
      }
      var n = m.url,
      l = m.width,
    ...
    adaptFrame: function (l, m) {
      h.add(l, 'resize', function (n) {
        n = c.unparam(n);
        if (n) {
          n.h && !isNaN(n.h) && (m.style.height = n.h + 'px');
          n.w && !isNaN(n.w) && (m.style.width = n.w + 'px')
        }
      })
    },
    resizeFrame: function (o, l, n) {
      ...
      function m() {
        if (t != r() || q != p()) {
          ...
          var u = o ? t : null,
          v = l ? q : null;
          h.fire(TOP.fields.frameId, 'resize', 'w=' + u + '&h=' + v)
        }
      }
      setInterval(m, 500)
    },
    ...
    dialog: function (l) {
      ...
      var m = confirm(l + '登陆第三方应用失败！可能是因为您浏览器的设置限制\n点击确认查看解决方案\n点击取消继续使用\n');
      if (m) {
        ...
        if (m && m === TOP.getMainDomain()) {
          if (o.match(/access_token=[^&]+|top_session=[^&]+/)) {
            ...
            if (k.top_session) {
              ...
              var h = lang.unparam(TOP.base64.decode(k.top_parameters));
    ...
    dispart: function (h, g) {
      if (h && typeof h === 'string') {
        try {
          ...
          d('cannot find opener or opener don\'t has required method', 'error')
        }
      }
    }
  });
  ...
  TOP.namespace('', {
    init: function (p) {
      ...
      try {
        ...
        q.src = 'http://gm.mmstat.com/connect.6.1?appkey=' + TOP.fields.appKey + '&cache=' + new Date().getTime()
      } catch (s) {
