    ...
    for (j = 0; j < a; j++) {
      ...
      for (k = 0; k < l; k++) {
        ...
        jQuery(u[j].childNodes[k]).click(function () {
          ...
          tempColor = null;//t;
		  if (e=='bgcolor'){
			  jQuery('#bgcolor').val(t);
			  jQuery('#bgcolor').attr('hx',t);
			  jQuery('#icp_bgcolor').css('background','');
			  jQuery('#icp_bgcolor').css('background-color',t);
		  }
  ...
  jQuery('input.iColorPicker').each(function (e) {
    if (e == 0) {
      ...
      jQuery('#iColorPicker').css({
        ...
        color: '#fff',
        'z-index': 9999
      }).before('<iframe id="icp_iframe" width="253" height="155" scrolling="no" frameborder="0" style="z-index:99;display:none;"></iframe>')
    }
