if (!function (a, b, c) {
  ...
  function e() {
    ...
    for (var i in k) if (k.hasOwnProperty(i)) {
      if (a = [
      ], b = k[i], b.name && (a.push(b.name.toLowerCase()), b.options && b.options.aliases && b.options.aliases.length)) for (c = 0; c < b.options.aliases.length; c++) a.push(b.options.aliases[c].toLowerCase());
      for (e = d(b.fn, 'function') ? b.fn()  : b.fn, f = 0; f < a.length; f++) g = a[f],
      h = g.split('.'),
      1 === h.length ? m[h[0]] = e : (!m[h[0]] || m[h[0]] instanceof Boolean || (m[h[0]] = new Boolean(m[h[0]])), m[h[0]][h[1]] = e),
      j.push((e ? '' : 'no-') + h.join('-'))
    }
  }
  function f(a) {
  ...
  function h() {
    var a = b.body;
    return a || (a = g(o ? 'svg' : 'body'), a.fake = !0),
    a
  }
  function i(a, c, d, e) {
    var f,
    ...
    m = g('div'),
    o = h();
    if (parseInt(d, 10)) for (; d--; ) j = g('div'),
    j.id = e ? e[d] : l + (d + 1),
    m.appendChild(j);
    return f = g('style'),
    f.type = 'text/css',
    ...
    m.id = l,
    o.fake && (o.style.background = '', o.style.overflow = 'hidden', k = n.style.overflow, n.style.overflow = 'hidden', n.appendChild(o)),
    i = c(m, a),
    o.fake ? (o.parentNode.removeChild(o), n.style.overflow = k, n.offsetHeight)  : m.parentNode.removeChild(m),
    !!i
  }
  var j = [
  ],
...
!function (a) {
  'function' == typeof define && define.amd ? define('picker', [
    'jquery'
  ], a)  : 'object' == typeof exports ? module.exports = a(require('jquery'))  : this.Picker = a(jQuery)
}(function (a) {
  function b(f, g, i, m) {
    function n() {
    ...
    B = A.prototype = {
      ...
      start: function () {
        ...
        }, w.start = !0, w.open = !1, w.type = f.type, f.autofocus = f == h(), f.readOnly = !x.editable, f.id = f.id || w.id, 'text' != f.type && (f.type = 'text'), B.component = new i(B, x), B.$root = a('<div class="' + y.picker + '" id="' + f.id + '_root" />'), p(), B.$holder = a(n()).appendTo(B.$root), q(), x.formatSubmit && r(), o(), x.containerHidden ? a(x.containerHidden).append(B._hidden)  : z.after(B._hidden), x.container ? a(x.container).append(B.$root)  : z.after(B.$root), B.on({
      ...
      stop: function () {
        return w.start ? (B.close(), B._hidden && B._hidden.parentNode.removeChild(B._hidden), B.$root.remove(), z.removeClass(y.input).removeData(g), setTimeout(function () {
          z.off('.' + w.id)
        }, 0), f.type = w.type, f.readOnly = !1, B.trigger('stop'), w.methods = {
        }, w.start = !1, B)  : B
      },
      open: function (c) {
        return w.open ? B : (z.addClass(y.active), e(f, 'expanded', !0), setTimeout(function () {
          ...
          e = B.component.key[d],
          f = c.target;
          27 == d ? B.close(!0)  : f != B.$holder[0] || !e && 13 != d ? a.contains(B.$root[0], f) && 13 == d && (c.preventDefault(), f.click())  : (c.preventDefault(), e ? b._.trigger(B.component.key.go, B, [
            b._.trigger(e)
          ])  : B.$root.find('.' + y.highlighted).hasClass(y.disabled) || (B.set('select', B.component.item.highlight), x.closeOnSelect && B.close(!0)))
        })), B.trigger('open'))
      },
      close: function (a) {
      ...
      get: function (a, c) {
        ...
        if (a in B.component.item) {
          if ('string' == typeof c) {
            ...
            return d ? b._.trigger(B.component.formats.toString, B.component, [
              c,
              d
            ])  : ''
          }
      ...
      off: function () {
        ...
        b,
        c = arguments;
        for (a = 0, namesCount = c.length; a < namesCount; a += 1) b = c[a],
  ...
  b._ = {
    group: function (a) {
      for (var c, d = '', e = b._.trigger(a.min, a); e <= b._.trigger(a.max, a, [
        e
      ]); e += a.i) c = b._.trigger(a.item, a, [
        e
      ]),
  ...
  b.extend = function (c, d) {
    a.fn[c] = function (e, f) {
      var g = this.data(c);
      return 'picker' == e ? g : g && 'string' == typeof e ? b._.trigger(g[e], g, [
        f
      ])  : this.each(function () {
        var f = a(this);
...
!function (a) {
  'function' == typeof define && define.amd ? define(['picker',
  'jquery'], a)  : 'object' == typeof exports ? module.exports = a(require('./picker.js'), require('jquery'))  : a(Picker, jQuery)
}(function (a, b) {
  function c(a, b) {
    var c = this,
    d = a.$node[0],
  ...
  c.prototype.createRange = function (a, c) {
    ...
    f.isInteger(c) || (c = e(c)),
    f.isInteger(a) && b.isPlainObject(c) ? a = [
      c.year,
      c.month,
      c.date + a
    ] : f.isInteger(c) && b.isPlainObject(a) && (c = [
      a.year,
      a.month,
      a.date + c
    ]),
  ...
  c.prototype.validate = function (a, c, d) {
    ...
    if ((!d || !d.nav && !d.defaultValue) && (!m && j.disabled(c) || m && j.disabled(c) && (p || e || g) || !m && (c.pick <= n.pick || c.pick >= o.pick))) for (m && !p && (!g && l > 0 || !e && 0 > l) && (l *= - 1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k, l = l > 0 ? 1 : - 1), c.pick <= n.pick ? (h = !0, l = 1, c = j.create([n.year,
    n.month,
    n.date + (c.pick === n.pick ? 0 : - 1)]))  : c.pick >= o.pick && (i = !0, l = - 1, c = j.create([o.year,
    o.month,
    o.date + (c.pick === o.pick ? 0 : 1)])), !h || !i); ) c = j.create([c.year,
    c.month,
    c.date + l]);
    return c
  },
  ...
  c.prototype.parse = function (a, b, c) {
    ...
    }, c.format = d.settings.format), d.formats.toArray(c.format).map(function (a) {
      var c = d.formats[a],
      g = c ? f.trigger(c, d, [
        b,
        e
    ...
    return {
      ...
      toString: function (a, b) {
        ...
        return c.formats.toArray(a).map(function (a) {
          return f.trigger(c.formats[a], c, [
            0,
            b
          ]) || a.replace(/^!/, '')
        }).join('')
  ...
  c.prototype.deactivate = function (a, c) {
    ...
    return 'flip' == c ? d.flipEnable()  : c === !1 ? (d.flipEnable(1), e = [
  ...
  c.prototype.activate = function (a, c) {
    ...
    e = d.item.disable,
    g = e.length;
    return 'flip' == c ? d.flipEnable()  : c === !0 ? (d.flipEnable(1), e = [
      ...
      for (i = 0; g > i; i += 1) {
        ...
        if (d.isDateOverlap(h, a)) {
          b.isPlainObject(a) ? (a.inverted = !0, c = a)  : b.isArray(a) ? (c = a, c[3] || c.push('inverted'))  : f.isDate(a) && (c = [
            a.getFullYear(),
            a.getMonth(),
            a.getDate(),
            'inverted'
  ...
  c.prototype.nodes = function (a) {
    ...
    q = function () {
      ...
      return c.selectMonths ? f.node('select', f.group({
        ...
        item: function (a) {
          return [d[a],
          0,
          'value=' + a + (k.month == a ? ' selected' : '') + (k.year == m.year && a < m.month || k.year == n.year && a > n.month ? ' disabled' : '')]
        }
    ...
    return f.node('div', (c.selectYears ? r() + q()  : q() + r()) + p() + p(1), c.klass.header) + f.node('table', o + f.node('tbody', f.group({
      ...
      node: 'tr',
      item: function (a) {
        var e = c.firstDay && 0 === b.create([k.year,
        k.month,
        1]).day ? - 7 : 0;
        return [f.group({
          min: d * a - k.day + e + 1,
...
function (a) {
  ...
  function b(b) {
    return this.each(function () {
      var d = a(this),
      e = d.data('bs.datepicker'),
      f = a.extend({
      }, c.DEFAULTS, d.data(), 'object' == typeof b && b);
      e || d.data('bs.datepicker', e = new c(this, f)),
      e.show()
    })
  }
  var c = function (b, c) {
  ...
  c.prototype.display = function (b, c) {
    a('.picker__box', c).wrapInner('<div class="picker__date-inner"></div>').prepend('<div class="picker__date-display"><div class="picker__date-display-top"><span class="picker__year-display">' + b.get('select', 'yyyy') + '</span></div><div class="picker__date-display-bottom"><span class="picker__weekday-display">' + b.get('select', 'dddd') + '</span><span class="picker__day-display">' + b.get('select', 'd') + '</span><span class="picker__month-display">' + b.get('select', 'mmm') + '</span></div></div>')
  },
  c.prototype.show = function () {
    var b = this;
    ...
    c.on({
      ...
      open: function () {
        null === c.get('select') ? c.set('select', c.get('highlight'))  : a('.picker__date-display', d).length || b.display(c, d)
      },
      render: function () {
        b.display(c, d)
      }
  ...
  var d = a.fn.datepicker;
  a.fn.datepicker = b,
  a.fn.datepicker.Constructor = c,
  a.fn.datepicker.noConflict = function () {
    return a.fn.datepicker = d,
    this
  }
}(jQuery),
function (a) {
...
function (a) {
  ...
  c.DEFAULTS = a.extend({
  }, a.fn.modal.Constructor.DEFAULTS, {
  }),
  c.TRANSITION_DURATION = 300,
  c.TRANSITION_DURATION_BACKDROP = 150,
  c.prototype = a.extend({
  }, a.fn.modal.Constructor.prototype),
  c.prototype.backdrop = function (b) {
    var d = this;
    if (this.isShown && this.options.backdrop) {
  ...
  c.prototype.show = function (b) {
    ...
    this.$element.trigger(e),
    this.isShown || e.isDefaultPrevented() || (this.isShown = !0, this.escape(), this.$element.on('click.dismiss.bs.menu', '[data-dismiss="menu"]', a.proxy(this.hide, this)), this.$dialog.on('mousedown.dismiss.bs.menu', function () {
...
function (a) {
  ...
  d.prototype = a.extend({
  }, a.fn.collapse.Constructor.prototype),
  ...
  d.prototype.show = function () {
    if (!this.transitioning && !this.$element.hasClass('in')) {
      var b,
      e = this.$parent && this.$parent.find('.tile-collapse').children('.in, .collapsing');
...
!function (a, b) {
  ...
  function e(a) {
    var b = m.call(a);
    return '[object String]' === b ? l(a)  : c(a) && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(b) && a.hasOwnProperty('length') ? a : d(a) ? [
      a
    ] : [
    ]
  }
  ...
  o = {
    ...
    show: function (a, b, c) {
      ...
      i = 0,
      j = 0;
      'touches' in a && a.touches.length ? (i = a.touches[0].pageY - h.top, j = a.touches[0].pageX - h.left)  : (i = a.pageY - h.top, j = a.pageX - h.left),
      j = j >= 0 ? j : 0,
      i = i >= 0 ? i : 0;
  ...
  k.attach = function (a, b) {
    ...
    b = b ? ' ' + b : '';
    for (var c, d, f = 0, g = a.length; g > f; f++) c = a[f],
    d = c.tagName.toLowerCase(),
    - 1 !== ['input',
    'img'].indexOf(d) && (p[d](c), c = c.parentElement),
