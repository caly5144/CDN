(function (e) {
  ...
  t.prototype = {
    ...
    setContent: function () {
      ...
      this.tooltip = e('<ins ' + tooltipId + ' class = \'dark-tooltip ' + this.options.theme + ' ' + this.options.size + ' ' + this.options.gravity + '\'><div>' + this.content + '</div></ins>');
